...
function showDetailModal(item) {
  ...
  modalContent.innerHTML = `
   ...
   <p><strong>防禦：</strong>${item.def || "N/A"}<strong>　　閃避：</strong>${
    item.dodge || "N/A"
  }</p>
   </div>
   ...
   <p><strong>光輝掉落(掉落較多)：</strong><span class="value">${
     item.drop_glory_high || "N/A"
   }</span></p>
   </div>
   <div class="section-gap">
   <p><strong>光輝掉落(掉落較低)：</strong><span class="value">${
     item.drop_glory_low || "N/A"
   }</span></p>
   </div>
   <div class="section-gap">
