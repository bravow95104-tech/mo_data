...
export const TABLE_CONFIGS = {
    ...
    weapons: {
        ...
        fields: [
            ...
            { id: 'material4', label: '材料4', type: 'text', grid: 1 },
            { id: 'material5', label: '材料5', type: 'text', grid: 1 },
            { id: 'material6', label: '材料6', type: 'text', grid: 1 },
            { id: 'material7', label: '材料7', type: 'text', grid: 1 },
            { id: 'material8', label: '材料8', type: 'text', grid: 1 },
            { id: 'material9', label: '材料9', type: 'text', grid: 1 },
            { id: 'material10', label: '材料10', type: 'text', grid: 1 },
            { id: 'material11', label: '材料11', type: 'text', grid: 1 },
            { id: 'illustrate', label: '說明(如要觸發modelbox請增加^&12&^)', type: 'textarea', grid: 3 },
    ...
    detailed_map: {
        ...
        fields: [
            { id: 'mapid', label: '地圖名稱', type: 'text', required: true, grid: 1 },
            { id: 'sort_id', label: '顯示順序', type: 'number', grid: 1 },
            { id: 'def', label: '防禦', type: 'number', grid: 1 },
            { id: 'dodge', label: '閃避', type: 'number', grid: 1 },
            { id: 'approach', label: '迷宮走法', type: 'textarea', grid: 1 },
            { id: 'illustrate', label: '說明', type: 'text', grid: 1 },
            { id: 'approach_a', label: '特別顯示', type: 'checkbox', options: ['要','城鎮','說明','洞窟'], grid: 1 }, //多選並用、分隔
