...
export const TABLE_CONFIGS = {
    heroes: {
        ...
        fields: [
            ...
            { id: 'equipment_new', label: '裝備卡(新專)', type: 'text', grid: 1 , group: '卡片'},
            { id: 'equipment_old', label: '裝備卡(舊專)', type: 'text', grid: 1 , group: '卡片'},
            { id: 'innate_skill', label: '天生技能(前)', type: 'text', grid: 1 , group: '技能'},
            { id: 'transformation_skill', label: '生變技能(後)', type: 'text', grid: 1 , group: '技能'},
    ...
    'card-equip': {
        ...
        fields: [
            { id: 'sort_id', label: '顯示順序', type: 'number', grid: 1 , group: '基礎'},
            { id: 'type', label: '類型', type: 'select', options: ['裝備卡'], grid: 1 , group: '基礎'},
            { id: 'check_use', label: '確認用', type: 'text', grid: 1 , group: '基礎'},
            { id: 'new_old', label: '新舊', type: 'select', options: ['','新專','舊專','馬卡'], grid: 1 , group: '基礎'},
            { id: 'card_id', label: '卡片名稱', type: 'text', grid: 1 , group: '基礎'},
            { id: 'card_class', label: '拜官', type: 'select', options: ['全職','武者','響馬','仙士','策士','工匠',''], grid: 1 , group: '基礎'},
            { id: 'card_property', label: '卡片屬性', type: 'select', options: ['','力量','智慧','體質','敏捷','運氣','HP','MP','攻擊力','防禦力','閃避值','命中值'], grid: 1 , group: '能力'},
            { id: 'card_data', label: '卡片數據', type: 'text', grid: 1 , group: '能力'},
            { id: 'card_lv', label: '卡片等級', type: 'text', grid: 1 , group: '能力'},
            { id: 'nemultiplier', label: '倍率', type: 'select', options: ['','2.5倍','2倍'], grid: 1 , group: '能力'},
            { id: 'card_mp', label: '卡片MP(無作用)', type: 'text', grid: 1 },
    ...
    map_zone_drops: {
        ...
        fields: [
            ...
            { id: 'drop_product', label: '產物', type: 'textarea', grid: 1, group: '掉落' },
            { id: 'drop_equidcard', label: '裝備卡', type: 'textarea', grid: 1, group: '掉落' },
            { id: 'drop_skillcard', label: '技能卡', type: 'textarea', grid: 1, group: '掉落' },
    ...
    random_quest: {
        ...
        fields: [
            ...
            { id: 'amount', label: '數量需求', type: 'text', grid: 1,  group: '基本資料'},
    ...
    events: {
        ...
        displayFields: ['title', 'start_date', 'end_date'],
        fields: [
            { id: 'title', label: '活動名稱', type: 'text', required: true, grid: 1 },
            { id: 'url', label: '活動連結', type: 'text', grid: 2 },
            { id: 'start_date', label: '開始日期 (例如 2026-08-05)', type: 'text', grid: 1 },
            { id: 'end_date', label: '活動結束時間 (例如 2026-08-05)', type: 'text', grid: 2 },
