...
export const INTERNAL_CONNECTIONS = {
    'guisha-1': {
        ...
        'portal-B': ['portal-feishan', 'portal-guigu', 'portal-A', 'portal-D', 'portal-E'],
        'portal-C': [],
        'portal-D': ['portal-feishan', 'portal-guigu', 'portal-A', 'portal-B', 'portal-E'],
        'portal-E': ['portal-feishan', 'portal-guigu', 'portal-A', 'portal-B', 'portal-D'],
        'portal-F': [],
    },
    'guisha-2': {
        'portal-A': [],
        'portal-B': [],
        'portal-C': ['portal-D', 'portal-E', 'portal-F', 'portal-3'],
        'portal-D': ['portal-C', 'portal-E', 'portal-F', 'portal-3'],
        'portal-E': ['portal-C', 'portal-D', 'portal-F', 'portal-3'],
        'portal-F': ['portal-C', 'portal-D', 'portal-E', 'portal-3'],
        'portal-3': ['portal-C', 'portal-D', 'portal-E', 'portal-F'],
    },
    'guisha-3': {
